...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El :attribute proporcionado aparecio en una filtracion de datos. Por favor elige otro.',
    ],
    ...
    */
    ...
    'custom' => [
        'date_of_birth' => [
            ...
            'before' => 'La fecha de nacimiento no puede ser futura.',
        ],
    ],

    /*
    |--------------------------------------------------------------------------
    | Atributos personalizados (nombres legibles para los campos)
    |--------------------------------------------------------------------------
    */
    ...
    'attributes' => [
        ...
        'insurance_policy_number' => 'numero de poliza',
        ...
        'professional_license' => 'numero de licencia',
