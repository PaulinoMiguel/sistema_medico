<x-layouts.tenant :title="'Detalle de Caja'">
    ...
    {{-- Estado de la entrega del dinero --}}
    @if($cashRegister->isPendingApproval())
        <div class="bg-amber-50 border border-amber-300 rounded-lg p-4 mb-6">
            <p class="text-sm font-semibold text-amber-900">Pendiente de recibir</p>
            <p class="text-sm text-amber-800 mt-1">
                La caja está contada y cerrada, pero el doctor todavía no ha recibido el dinero.
                Se recibe desde la pantalla de Caja.
            </p>
        </div>
