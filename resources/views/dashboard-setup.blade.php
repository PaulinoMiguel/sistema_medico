<x-layouts.tenant :title="'Configuración inicial'">
    <div class="max-w-2xl mx-auto mt-10">
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 mt-2">Tu cuenta aún no tiene clínicas asignadas.</p>
        </div>
            ...
            <div class="text-center">
                <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-6 mb-6">
                    ...
                    <p class="text-sm text-gray-600">
                        Las clínicas y la asignación de doctores son gestionadas por el administrador del sistema.
                        Solicita que te asigne a una clínica para comenzar a trabajar.
                    </p>
                </div>
